...
import SliderComp from "./Extras/SliderComp";
...
export default function Home(){
    ...
    <Box height="30rem"  bg="gray.50" backgroundSize="cover" alignContent="center" padding="2.5rem">
        <Text color="blue.600" fontSize="2xl"  align="center" fontWeight="semibold">EXPLORE THE WORLDS BEST CAR RENTAL MARKETPLACE</Text>
        ...
        <Flex padding="2rem">
            ...
            <Text  align="center" justifyContent="center" fontSize="xl" fontWeight="semibold">Payment on Reception</Text>
            <Text  align="center" justifyContent="center" padding = "2.5rem">You can reserve your car at any time, payment come later after you receive it</Text>
            </Box>
            <Box width="25%" borderRight="1px" borderRightColor="blue.600" borderRightStyle="dotted">
            <Container padding = "1rem"  align ="center"> <img  src={easyBook} alt="icon of booking" /></Container>   
            <Text  align="center" justifyContent="center" fontSize="xl" fontWeight="semibold"> Easy Booking </Text>
            <Text  align="center" justifyContent="center" padding = "2.5rem">Choose your car then book with a click of a button</Text>
            </Box>
            <Box width="25%" borderRight="1px" borderRightColor="blue.600" borderRightStyle="dotted">
            <Container padding = "1rem"  align ="center"> <img  src={car} alt="icon of car" /></Container>
            <Text  align="center" justifyContent="center" fontSize="xl" fontWeight="semibold">Wide Variety of Cars</Text>
            <Text  align="center" justifyContent="center" padding = "2.5rem">We’ve got cars of all types. Filter to your Taste.</Text>
            </Box>
            <Box width="25%" alignContent="center" >
            <Container padding = "1rem"  align ="center"> <img  src={offer} alt="icon of offer" /></Container>
            <Text  align="center" justifyContent="center" fontSize="xl" fontWeight="semibold">Discounts</Text>
            <Text  align="center" justifyContent="center" padding = "2.5rem">You can always benefit from our daily discounts that go up to 70%</Text>
            </Box>
        </Flex>
    </Box>

    <Box height="28rem" backgroundImage={logoDesign} backgroundPosition="center"></Box>
    <Box height="48rem"  bg="white" backgroundRepeat="no-repeat" backgroundSize="cover" alignContent="center" padding="4rem">
        <Text color="gray.800" fontSize="4xl"  align="Left" fontWeight="extrabold" padding="1rem">Browse by Make</Text>
        ...
        <Flex padding="2rem">
            ...
            <Text  align="center" justifyContent="center" fontSize="xl" fontWeight="semibold">Lumbergini</Text>
            </Box>
           </Flex>


           <Text color="gray.800" fontSize="4xl"  align="Left" fontWeight="extrabold" padding="1rem">Browse by Destination</Text>
           <Flex padding="2rem">
            <Box width="25%">
