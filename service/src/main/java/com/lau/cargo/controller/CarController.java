...
import com.lau.cargo.entity.Car;
import com.lau.cargo.repository.CarRepository;
...
public class CarController {
    ...
    @DeleteMapping("/{carId}")
    public ResponseEntity<?> deleteCar(@PathVariable(value = "carId") Long carId) throws Exception {
        Car car;
        if(carRepository.existsById(carId)) {
