...
import com.lau.cargo.entity.Review;
import com.lau.cargo.repository.ReviewRepository;
...
public class ReviewController {
    ...
    public ResponseEntity<?> deleteReview(@PathVariable(value = "reviewId") Long reviewId) throws Exception {
        Review review;
        if(reviewRepository.existsById(reviewId)) {
